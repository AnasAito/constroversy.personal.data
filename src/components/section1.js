    ...
    <section className="pb-20 bg-gray-300 -mt-24 ">
      <div className="container mx-auto px-4 ">
        ...
        <div className=" bg-red-200 rounded-full border border-red-200 w-40 text-center text-left mt-4 mb-4 text-gray-800">
          <p className="text-xl  ">Stockage</p>
        </div>
        <div className="flex flex-wrap items-center mt-32">
          ...
          <div className=" px-4 mr-auto ml-auto">
            <div className=" flex flex-col min-w-0 break-words bg-transparent w-full mb-6 shadow-lg rounded-lg  border-4 border-dashed border-gray-400 p-10 ">
              <Table />
            </div>
          </div>
        </div>
