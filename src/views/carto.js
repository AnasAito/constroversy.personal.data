          ...
          <Modal
            ...
            text={
              <p className="text-justify">
                ...
                législative.
                <p className="text-justify">
                  Chaque cartographie est modélisée par un slider que vous
                  pouvez faire glisser pour dévoiler deux facettes superposées.
                  Facette Acteurs, dans laquelle nous subdivisons nos acteurs en
                  trois grandes catégories :{" "}
                </p>
                <p className="text-justify px-2">
                  {" "}
                  1- <span className="text-red-500">Douteux et méfiants</span> ,
                  par rapport à la problématique relative à chaque cartographie.
                </p>
                <p className="text-justify px-2">
                  {" "}
                  2-{" "}
                ...
                <p className="text-justify">
                  Facette Arguments et Problèmes soulevés, que nous repérons
                  pour chaque catégorie d'acteurs. Les arguments d'une catégorie
                  ont la même couleur de celle-ci.
                </p>
              </p>
            }
